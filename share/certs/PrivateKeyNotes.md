...
unlocked to sign the Eurocoin-Qt.app bundle.
...
allowing somebody to distribute a Eurocoin-Qt.app or eurocoin-qt-setup.exe with a valid
...
that the eurocoin-qt.exe file inside the installer had not been tampered with.

...
#ifndef _EUROCOINRPC_H_
#define _EUROCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Eurocoin is not connected
...
/**
 * Eurocoin RPC command dispatcher.
 */
class CRPCTable
{
private:

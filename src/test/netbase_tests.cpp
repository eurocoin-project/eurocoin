...
{
    BOOST_CHECK(TestSplitHost("www.europroject.co", "www.europroject.co", -1));
    BOOST_CHECK(TestSplitHost("[www.europroject.co]", "www.europroject.co", -1));
    BOOST_CHECK(TestSplitHost("www.europroject.co:80", "www.europroject.co", 80));
    BOOST_CHECK(TestSplitHost("[www.europroject.co]:80", "www.europroject.co", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8051", "127.0.0.1", 8051));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8051", "127.0.0.1", 8051));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8051", "::ffff:127.0.0.1", 8051));
    BOOST_CHECK(TestSplitHost("[::]:8051", "::", 8051));
    BOOST_CHECK(TestSplitHost("::8051", "::8051", -1));
    BOOST_CHECK(TestSplitHost(":8051", "", 8051));
    BOOST_CHECK(TestSplitHost("[]:8051", "", 8051));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8051", "127.0.0.1:8051"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8051", "[::]:8051"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

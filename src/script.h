...
#ifndef H_EUROCOIN_SCRIPT
#define H_EUROCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEurocoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Eurocoin always counted CHECKMULTISIGs
